		...
		<div class="product">
			...
			%>
				...
				<div class="bd-color-grey">
	                ...
	                %>
						<a
							href="admin_suitcategory.jsp?Kind=<%=Kind%>&&pageNum=<%=endPage-pageBlock %>"
							class="item"> 이전 </a>
					<% 
                      } 
                      ...
                      for(int s=startPage; s<=endPage; s++){
                         if(s == pageNum){
                  	%>
						<a href="admin_suitcategory.jsp?Kind=<%=Kind%>&&pageNum=<%=s %>"
							class="item"><b> <%=s %>
						</b></a>
					<%
                         }
					...
					<% 
                 	...
                 	%>
						<a
							href="admin_suitcategory.jsp?Kind=<%=Kind%>&&pageNum=<%=startPage+pageBlock %>"
							class="item"> 다음 </a>
					<% 
                       }
                   }                   
