...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="admin_suitdetail.css">
...
<body>
	...
	<%
      ...
      %>
	<form name="cartForm"
		action="admin_qrcode.jsp?register_num=<%=register_num %>"
		method="post">
		<div class="detail-product">
			<div class="detail__img__box">
				<ul class="small__product__list">
					<li class="small__product__img"><a href="javascript:void(0)"
						onclick="switch_img('img_1', 5);"><img
							src="../upload/<%=mainimg%>" alt="" /></a></li>
					<li class="small__product__img"><a href="javascript:void(0)"
						onclick="switch_img('img_2', 5);"><img
							src="../upload/<%=detailimg1%>" alt="" /></a></li>
					<li class="small__product__img"><a href="javascript:void(0)"
						onclick="switch_img('img_3', 5);"><img
							src="../upload/<%=detailimg2%>" alt="" /></a></li>
					<li class="small__product__img"><a href="javascript:void(0)"
						onclick="switch_img('img_4', 5);"><img
							src="../upload/<%=detailimg3%>" alt="" /></a></li>
					<li class="small__product__img"><a href="javascript:void(0)"
						onclick="switch_img('img_5', 5);"><img
							src="../upload/<%=detailimg4%>" alt="" /></a></li>
				</ul>
			</div>
			<div id="img_1">
				<img src="../upload/<%=cbean.getRegister_mainimg()%>"
					class="big__product__img" />
			</div>
			<div id="img_2" style="display: none;">
				<img src="../upload/<%=cbean.getRegister_detailimg1()%>"
					class="big__product__img" />
			</div>
			<div id="img_3" style="display: none;">
				<img src="../upload/<%=cbean.getRegister_detailimg2()%>"
					class="big__product__img" />
			</div>
			<div id="img_4" style="display: none;">
				<img src="../upload/<%=cbean.getRegister_detailimg3()%>"
					class="big__product__img" />
			</div>
			<div id="img_5" style="display: none;">
				<img src="../upload/<%=cbean.getRegister_detailimg4()%>"
					class="big__product__img" />
			</div>
			<div class="detail-product__content">
				<h2 class="detail-product__title">
					<input type="hidden" value="<%=name %>" name="name" /><%=name %></h2>
				<ul class="detail-product__list">
					<li class="detail-product__text">
						<h3>정장 색상</h3>
						<p>
							<input type="hidden" value="<%=color%>" name="color" /><%=color%></p>
					</li>
					<li class="detail-product__text">
						<h3>사이즈</h3>
						<p>
							<input type="hidden" value="<%=size%>" name="size" /><%=size %></p>
					</li>
					<li class="detail-product__text">
						<h3>보유 구청</h3>
						<p>
							<input type="hidden" value="<%=office%>" name="office" /><%=office%></p>
					</li>
					<li class="detail-product__text">
						<h3>대여 가격</h3>
						<p>
							<input type="hidden" value="<%=price%>" name="price" /><%=price%></p>
					</li>
					<li class="detail-product__text">
						<h3>피팅 날짜 선택</h3> <input name="fitting_date" type="date"
						class="select__date">
					</li>
					<li class="detail-product__text">
						<h3>피팅 시간 선택</h3> <select name="fitting_time" class="input1">
				...
				<div class="detail-page__button">
					<ul>
						<li><input class="review__button" type="button" id="rvbtn"
							value="정장후기 보기" onclick="rvMove()"></li>
						<li><input class="reservation__button" type="submit"
							value="이용신청 QR코드"></li>
	...
	<div class="review-part" id="rvMove">
		...
		<table class="table1" id="contents">
			...
			<tr id="contents" class="table__content">
				...
				<td class="content2"><a href="#rvMove" class="review__link"><%=cBean.getReview_title()%></a>
				</td>
				<%
			...
			<tr class="table__content2">
				<td colspan="5" class="conts"><%=cBean.getReview_content()%> <br>
					<br> <img class="product__img"
					src="../upload/<%=cBean.getReview_img()%>" height="200"
					width="200"></td>
			</tr>
			<%
				}
		...
		<div class="review__button__part">
			<input type="hidden" value="후기작성" class="review__btn"
		...
		<div class="bd-color-grey">
			<div class="page_number">
                ...
                %>
				<a
					href="suitdetail.jsp?register_num=<%=snum%>&&pageNum=<%=endPage-pageBlock %>#rvMove"
					class="item"> 이전 </a>
				<% 
                     } 
                ...
                %>
				<a
					href="suitdetail.jsp?register_num=<%=snum%>&&pageNum=<%=s %>#rvMove"
					class="item"><b> <%=s %>
				</b></a>
				<% 
                        }
                ...
                %>
				<a
					href="suitdetail.jsp?register_num=<%=snum%>&&pageNum=<%=startPage+pageBlock %>#rvMove"
					class="item"> 다음 </a>
				<% 
                      }
                  }  
