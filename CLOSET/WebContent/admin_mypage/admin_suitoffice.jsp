            ...
            %>
               ...
               %>
						<td class="product__content"><a
							href="admin_suitdetail.jsp?register_num=<%=num%>"> <img
								class="product__img" src="../upload/<%=mainimg%>">
               ...
               %>
				...
				<div class="bd-color-grey">
                  ...
                  %>
						<a
							href="admin_suitoffice.jsp?Office=<%=Office%>&&pageNum=<%=endPage-pageBlock %>"
							class="item"> 이전 </a>
						<% 
                      } 
                      ...
                      for(int s=startPage; s<=endPage; s++){
                         if(s == pageNum){
                  %>
						<a href="admin_suitoffice.jsp?office=<%=Office%>&&pageNum=<%=s %>"
							class="item"><b> <%=s %>
						</b></a>
						<%
                         }
                  ...
                  %>
						<a
							href="admin_suitoffice.jsp?office=<%=Office%>&&pageNum=<%=startPage+pageBlock %>"
							class="item"> 다음 </a>
						<% 
                       }
                   }
