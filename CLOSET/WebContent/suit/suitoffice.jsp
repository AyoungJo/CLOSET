...
<script type="text/javascript">
   function office(val){
      ...
      window.location.href="suitoffice.jsp?office="+encodeURI(office,"UTF-8"); 
   }
</script>
<script>
    	...
    	<!-- 검색결과 -->
    	 <div class="product">
            <div class="product__title__content">
                <h3 class="product__title">검색 결과</h3>
            ...
            <table class="product__table">
             <%
                ...
                totalCount = cdao.OfficeCount(Office);
          ...
          /* String Office = new String(request.getParameter("office").getBytes("ISO-8859-1"),"UTF-8"); */
             ArrayList<closetBean> oList= cdao.getRegisterOffice(startRow, endRow, Office);
           
             //3개씩 보여주기
             int j=0;
             for(int i=0; i< oList.size();i++){
                closetBean cbean=oList.get(i);
          ...
          <div class="bd-color-grey">
               <div class="page_number">   
                  ...
                  %>
                      <a href="suitoffice.jsp?Office=<%=Office%>&&pageNum=<%=endPage-pageBlock %>" class="item"> 이전 </a>
                  <% 
                      } 
                      ...
                      for(int s=startPage; s<=endPage; s++){
                         if(s == pageNum){
                  %>
                            <a href="suitoffice.jsp?office=<%=Office%>&&pageNum=<%=s %>" class="item"><b> <%=s %> </b></a>
                  <%
                         }
                         else{
                  %>
                            <a href="suitoffice.jsp?office=<%=Office%>&&pageNum=<%=s %>" class="item"> <%=s %> </a>
                  <% 
                         }
                      }
                      ...
                      if(endPage<pageCount){
                  %>
                  	  <a href="suitoffice.jsp?office=<%=Office%>&&pageNum=<%=startPage+pageBlock %>" class="item"> 다음 </a>
                  <% 
                       }
                   }
