			...
			<form class="form1">
				<table class="table1">
					<tr>
						...
						<td class="table__content"><input type="text"
							class="table__input"></td>
					</tr>
					<tr>
						<td class="table__title1">
							<h5>작성자</h5>
					...
					<tr>
						...
						<td class="table__content"><input type="date"
							class="table__input"></td>
					</tr>
					<tr>
						...
						<td class="table__content"><textarea class="table__input2"
								cols="72" rows="100"></textarea></td>
					</tr>
					<tr>
						<td class="table__title3">
							<h5>이미지</h5>
						</td>
						<td class="table__content"><input type="file" name="pic"
							class="table__input3" /></td>
					</tr>
				</table>
				<div class="btn_part">
