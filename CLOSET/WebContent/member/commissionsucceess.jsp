...
<head lang="en">
	<meta charset="UTF-8">
    <link rel="stylesheet" href="commissionsuccess.css">
        ...
        <div class="container-wrap">
            ...
            <form class="form1">
                <table class="table1">
                    <tr>
                    <td>
                       <h1 class="title1">위탁 신청서 제출이 완료되었습니다.</h1>
                    </td>
                    </tr>
                </table>
                <!--  정장위탁바로가기 를 위탁신청서확인하기로 바꿀지 목록으로 갈지 .. 위탁신청서확인하면 이전페이지에서 작성한 데이터들을 불러와야함  -->
                <input class="button2" type="button" value="정장위탁바로가기" onclick="location.href='commission.jsp'" >
            </form>
