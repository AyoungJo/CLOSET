...
<body>
	...
	%>
	<center>
		<b><font color="red"><%=email%></font>는 <br> 이미 사용중인 이메일
			입니다.</b>
		<form name="checkForm" method="post" action="emailCheck.jsp"
			onsubmit="return emailCheck2()">
			<b>다른 이메일을 입력해주세요.</b> <br>
			<br> <input type="text" name="inputEmail" id="inputEmail">
	...
	%>
		<center>
			<b><font color="red"><%=email%></font>는 사용가능한 이메일 입니다.</b><br>
			<br> <input type="button" value="사용하기" onclick="setEmail()">
		</form>
		</center>
	<%
		}
