...
<head>
	<meta charset="UTF-8">
    <link rel="stylesheet" href="mypage_withdraw.css">
...
<script type="text/javascript">
	function withdrawcheck(){
    	...
    	//확인을 눌렀을 시
    	if(con == true){
    		location="mypage_withdrawProc.jsp";
    	}
	}
    ...
    <div class="content">
        ...
        <div class="container" style="min-height: 650px;">
            <div class="container-wrap">
               <h1 class="title1">회원탈퇴
               </h1>
                
                <form class="form1" action="mypage_withdrawProc.jsp" method="post" onclick="return withdrawcheck();">
                    <table class="table1">
                        <tr>
                        <td class="td">
                           <h4 class="table_title">회원탈퇴 안내</h4>
                            고객님께서 회원 탈퇴를 원하신다니 저희 쇼핑몰의 서비스가 많이 부족하고 미흡했나 봅니다. <br>불편하셨던 점이나 불만사항을 알려주시면 적극 반영해서 고객님의 불편함을 해결해 드리도록 노력하겠습니다. <br><br>
                            아울러 회원 탈퇴시 아래 사항을 숙지하시기 바랍니다. <br>
                            1. 회원 탈퇴 시 고객님의 정보는 소비자 보호에 관한 법률에 의거한 고객정보 보호정책에 따라 관리 됩니다.<br>
                    ...
                    <div class="button__part">
                        ...
                        <input class="button2" type="submit" value="탈퇴" >
                    </div>
                </form>
            </div>
        </div>
