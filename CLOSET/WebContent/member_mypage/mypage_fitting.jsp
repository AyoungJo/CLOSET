...
<head>
<meta charset="UTF-8">
    <link rel="stylesheet" href="mypage_fitting.css">
        ...
        <div class="bottom__menu">
            ...
            <div class="menu">
                <ul class="menu__list1"> 
                    ...
                    <li class="menu__text1" onclick="changepage(5)" onmouseover="this.style.color='#30cfc0'" onmouseout="this.style.color='#000000'">정장대여</a>
                        <ul class="sub-menu__list">
                            <li class="sub-menu__list__text" onclick="changepage(6)" onmouseover="this.style.color='#30cfc0'" onmouseout="this.style.color='#000000'">남자 정장</li>
                            <li class="sub-menu__list__text" onclick="changepage(7)" onmouseover="this.style.color='#30cfc0'" onmouseout="this.style.color='#000000'">여자 정장</li>
                        </ul>
                    </li>|
                    <%
                    ...
                    %>
                    <li class="menu__text1"><a href="#">자원봉사</a>
                    </li>|
                    <%
                    if(session.getAttribute("sessionID") != null) // 로그인이 되었을 때
                    {
                    ...
                    <li class="menu__text1"><a href="../member_mypage/mypage.jsp?member_email=<%=sessionID%>">마이페이지</a>
                        <ul class="sub-menu__list">
                            ...
                            <li class="sub-menu__list__text"><a href="#">자원봉사</a></li>
    ...
    <div class="content">
        ...
        <div class="category">
            ...
            <ul class="category__list">
               <li class="category__text"><a href="mypage.jsp">위탁정장</a></li>
                ...
                <li class="category__text"><a href="#">자원봉사</a></li>
        ...
        <div class="container" style="min-height: 650px;">
            <div class="container-wrap">
               <h1 class="title1">피팅예약내역
                   <span class="title2">착용을 예약한 정장 정보에 대해 확인합니다.</span>
               </h1>
                ...
                <form class="form1">
                    <table class="table1">
                        ...
                        <tr class="table__content">
                            ...
                            <td class="content1">
                                <a href="../member_mypage/mypage_fittingreservation.jsp" class="commission__link">피팅예약신청서</a>
                            </td>
                            <td class="content2">
                                2019-11-08
                            </td>
                        ...
                        <tr class="table__content">
                            ...
                            <td class="content1">
                                <a href="#" class="commission__link">피팅예약신청서</a>
                            </td>
                            <td class="content2">
                                2019-11-01
                            </td>
