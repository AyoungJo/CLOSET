...
<head>
<meta charset="UTF-8">
    <link rel="stylesheet" href="mypage_mysuit.css">
    ...
    <div class="content">
        ...
        <div class="container" style="min-height: 650px;">
            <div class="container-wrap">
               <h1 class="title1">나의 정장
                   <span class="title2">CLOSET에 이용한 정장 내역 조회가 가능합니다.</span>
               </h1>
               ...
               <h3 class="title3">
                ...
                <form class="form1">
                    ...
                    <%
					    	...
					    	ArrayList<closetBean> a = cdao.getApply(member_email);
					 
					    	int j=0;
					    	for(int i=0; i<a.size(); i++){
					    		closetBean abean = a.get(i);
                    			//closetBean apply = cdao.getApplyMainimg();
                        ...
                        <tr class="product__line">
                            ...
                            <td class="product__content">
                                <a href="../suit/suitdetail.jsp?register_num=<%=abean.getApply_suitnum()%>">
                                		<img class="product__img" src="../upload/<%=abean.getRegister_mainimg() %>">
                                    	<h4 class="product__content__title"><%=abean.getApply_suitname() %></h4>
                                    	<p class="product__content__price"><%=abean.getApply_period1() %></p>~
                                    	<p class="product__content__price"><%=abean.getApply_period2() %></p>
                                		</a>
                            </td>
                            <%      
                  				j++;
