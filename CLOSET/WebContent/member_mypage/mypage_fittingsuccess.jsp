...
<head>
 	<meta charset="UTF-8">
    <link rel="stylesheet" href="mypage_fittingsuccess.css">
    <script 
        ...
        <div class="container-wrap">
            ...
            <form class="form1">
                <table class="table1">
                    <tr>
                    <td>
                       <h1 class="title1">피팅 예약이 신청되었습니다.</h1>
                    </td>
                    </tr>
                </table>
                <input class="button2" type="button" onclick="location.href='../member_mypage/mypage_fitting.jsp'" value="피팅예약내역 확인">
            </form>
