    ...
    <div class="content">
        ...
        <div class="container" style="min-height: 650px;">
            <div class="container-wrap">
               <h1 class="title1">위탁정장
                   <span class="title2">CLOSET에 위탁한 정장 내역 조회가 가능합니다.</span>
               </h1>
                ...
                <form class="form1">
                    <table class="table1">
                        ...
                        <%
					    	...
					    	ArrayList<closetBean> r = cdao.getReferral(member_email);
					    	...
					    	for(int i=0; i<r.size(); i++){
					    		closetBean rbean = r.get(i);
			    		%>
                        
                        <tr class="table__content">
                            <td class="content1"><%= rbean.getReferral_num() %></td>
                            <td class="content1">
                                <a href="mypage_commission_confirm.jsp?referral_num=<%=rbean.getReferral_num() %>" class="commission__link">정장위탁 신청서</a>
                            </td>
                            <td class="content2">
                                	<%=rbean.getReferral_agreement() %>
                            </td>
                            <td class="content2">
                                	<%=rbean.getReferral_date() %>
                            </td>
                        </tr>
                        <%    
					   		}
