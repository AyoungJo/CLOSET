...
<head>
   <meta charset="UTF-8">
    <link rel="stylesheet" href="mypage_commission_confirm.css">
    ...
    <div class="container" style="min-height: 650px;">
        <div class="container-wrap">
            ...
            <form class="form1">
                ...
                if (cbean.getReferral_agreement().equals("동의함")){
                %>
                <input class="button3" type="button" value="수정하기" onclick ="location.href='../member_mypage/mypage_commission_revise.jsp?referral_num=<%=cbean.getReferral_num() %>'">
                <input class="button4" type="button" value="마이페이지" onclick="location.href='../member_mypage/mypage.jsp?member_email=<%=sessionID%>'">
                <input class="button5" type="button" value="기부증서 보기" onclick="location.href='../member_mypage/mypage_donation.jsp'" >
                <%
                }else if(cbean.getReferral_agreement().equals("동의하지않음")){
                %>
                  <input class="button1" type="button" value="수정하기" onclick ="location.href='../member_mypage/mypage_commission_revise.jsp?referral_num=<%=cbean.getReferral_num() %>'">
                <input class="button2" type="button" value="마이페이지" onclick="location.href='../member_mypage/mypage.jsp?member_email=<%=sessionID%>'">
                <%
                }
                %>
              ...
              <div class="footer__content">
                ...
                %>                 
                 <li><a href="../join/login.jsp">정장위탁</a>
                   ...
                   %>
                      <li><a href="../member_mypage/mypage_volunteer.jsp?member_email=<%=sessionID%>">자원봉사</a></li>
                  </ul>
              </div>
              <div class="footer__content">
