...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="mypage_fittingreservation.css">
            ...
            <h1 class="title1">피팅 예약 내역</h1>
                ...
                <table class="table1" id="cartTable">
                  ...
                  <tr class="table__content" >
                              <td class="content2">
                                <img src="../images/a1.png" class="icon">
                               </a>
                              </td>
                   ...
                   <tr class="table__content" >
                              <td class="content2">
                                <img src="../images/x1.png" class="icon">
                               </a>
                              </td>
            	...
            	<input type="button" value="목록보기" onclick="location.href='../member_mypage/mypage_fitting.jsp'" class="button1" >
            </form>
        </div>
    </div>
